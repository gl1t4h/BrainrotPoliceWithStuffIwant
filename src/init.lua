...
function env.getgitpath(where)
    local mainBuild = "https://raw.githubusercontent.com/gl1t4h/BrainrotPoliceWithStuffIwant/refs/heads/main/"
    if where == "src" then
...
if queue_on_teleport then
    queue_on_teleport('loadstring(game:HttpGet("https://raw.githubusercontent.com/gl1t4h/BrainrotPoliceWithStuffIwant/refs/heads/main/src/init.lua"))()')
end
