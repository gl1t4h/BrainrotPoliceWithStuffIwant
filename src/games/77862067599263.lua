...
return function(section, data)
    ...
    elements:Toggle("Farm Magma Drag", section, setdata.farmrots, function(v)
        env.Farming = v
        env.setconfig("farmrots", v)
        if not env.Farming then return end
    ...
    elements:Toggle("Farm Disco Skib", section, setdata.farmrots, function(v)
        env.Farming = v
        env.setconfig("farmrots", v)
        if not env.Farming then return end
